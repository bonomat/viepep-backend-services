...
public class Tasks {
    ...
    public Tasks() {
        ...
        tasks.put(3, new Task(15.0, 120.0));
        tasks.put(4, new Task(30.0, 100.0));
        tasks.put(5, new Task(45.0, 10.0));
        tasks.put(6, new Task(55.0, 20.0));
        tasks.put(7, new Task(70.0, 40.0));
